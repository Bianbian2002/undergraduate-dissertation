#!/bin/bash
#SBATCH --job-name=calculate_minor_pop_PRS_%j
#SBATCH --output=/gpfs/gibbs/pi/zhao/zb222/Anotation_pipeline/method_calculate/get_PRS/Log/3.27/calculate_minor_pop_PRS_%A_%a.log
#SBATCH --requeue

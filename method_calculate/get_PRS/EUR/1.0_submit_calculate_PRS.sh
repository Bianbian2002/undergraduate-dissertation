#!/bin/bash
#SBATCH --job-name=submit_EUR_PRS_cal
#SBATCH --output=/gpfs/gibbs/pi/zhao/zb222/Anotation_pipeline/method_calculate/get_PRS/Log/3.17/submit_EUR_PRS_cal_%j.log
#SBATCH --requeue

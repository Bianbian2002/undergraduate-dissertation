#!/bin/bash
#SBATCH --job-name=concatenate_EUR
#SBATCH --output=/gpfs/gibbs/pi/zhao/zb222/Anotation_pipeline/method_calculate/getbeta_full/Log/3.17/concatenate_EUR_%j.log
#SBATCH --requeue
...
#    echo -e "rsID\tA1\tauto" > "$out_file"
    ...
    # Combine files
    for chr in {1..22}; do
        input_file="${IN_DIR}/trait_${trait}/tar_${pop}/baselineLD_v2.3_Annot_${k}/${trait}_${pop}_JointPRS_baselineLD_v2.3_Annot_${k}_${pop}_pst_eff_a1_b0.5_phiauto_chr${chr}.txt"

#!/bin/bash
#SBATCH --job-name=beta_minor_pop_cal
#SBATCH --partition=scavenge,day,week
#SBATCH --requeue
#SBATCH --output=/gpfs/gibbs/pi/zhao/zb222/Anotation_pipeline/method_calculate/getbeta_full/Log/3.27/beta_minor_pop_cal_%A_%a.out
